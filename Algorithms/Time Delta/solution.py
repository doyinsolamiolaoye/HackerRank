...
def time_delta(t1, t2):
    ...
    diff = (t2-t1).total_seconds()  #.total_seconds() method is used on a timedelta object to return the total number of seconds contained in the duration
    #timedelta object is the result of the difference between two datetime objects
